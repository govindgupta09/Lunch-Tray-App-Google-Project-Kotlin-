...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.checkoutFragment == variableId) {
            setCheckoutFragment((com.govi.lunchtray.ui.order.CheckoutFragment) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.govi.lunchtray.model.OrderViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCheckoutFragment(@Nullable com.govi.lunchtray.ui.order.CheckoutFragment CheckoutFragment) {
    ...
    public void setViewModel(@Nullable com.govi.lunchtray.model.OrderViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelAccompaniment((androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem>) object, fieldId);
            case 1 :
                return onChangeViewModelEntree((androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem>) object, fieldId);
            case 2 :
                return onChangeViewModelTotal((androidx.lifecycle.LiveData<java.lang.String>) object, fieldId);
            case 3 :
                return onChangeViewModelSide((androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem>) object, fieldId);
            case 4 :
                return onChangeViewModelTax((androidx.lifecycle.LiveData<java.lang.String>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelAccompaniment(androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> ViewModelAccompaniment, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    private boolean onChangeViewModelEntree(androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> ViewModelEntree, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    private boolean onChangeViewModelSide(androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> ViewModelSide, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x8L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> viewModelAccompaniment = null;
        ...
        com.govi.lunchtray.model.MenuItem viewModelEntreeGetValue = null;
        java.lang.String viewModelAccompanimentNameToString = null;
        com.govi.lunchtray.model.MenuItem viewModelSideGetValue = null;
        com.govi.lunchtray.model.MenuItem viewModelAccompanimentGetValue = null;
        com.govi.lunchtray.ui.order.CheckoutFragment checkoutFragment = mCheckoutFragment;
        java.lang.String viewModelSideFormattedPrice = null;
        androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> viewModelEntree = null;
        java.lang.String viewModelAccompanimentName = null;
        androidx.lifecycle.LiveData<java.lang.String> viewModelTotal = null;
        androidx.lifecycle.LiveData<com.govi.lunchtray.model.MenuItem> viewModelSide = null;
        ...
        com.govi.lunchtray.model.OrderViewModel viewModel = mViewModel;
